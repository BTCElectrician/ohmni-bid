...
Agent instructions for this repo. Keep this file short and point to deeper docs as needed.

## Global rules (from /Users/collin/Desktop/codex-skills/templates/AGENTS.global.md)
...
- Default parameter source-of-truth, update checklist, and architecture notes live in `AGENT_GUIDE.md`.
